...
const podcastEpisodes = [
  ...
  {
    title: 'Lekarz te człowiek',
    duration: '26:48',
    description: 'to szczera rozmowa o wypaleniu zawodowym — o tym, jak presja, odpowiedzialność i ciągłe bycie „dla innych” potrafią wypalić nawet najbardziej oddanych medyków. To opowieść o granicach, regeneracji i odzyskiwaniu siebie w zawodzie, który nigdy nie wyłącza światła',
    url: 'https://www.e-medycyna.pl/lekarz-tez-czlowiek',
  },
];
...
const projects = [
  ...
  {
    title: 'Summer Med Vibes',
    summary: 'Letnia szkoła praktycznej medycyny — lekko, konkretnie i wakacyjnie. Każdy odcinek to szybkie, przydatne zagadnienia zdrowotne, które naprawdę mogą się przydać w podróży, nad wodą, w górach czy podczas letnich aktywności.',
  },
];
